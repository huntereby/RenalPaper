...
gsms <- paste0("00X0X000X0X00000X00XXXXXXXXXXXXXXX11XX1X11111X1XX1",
               "11111X1XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
               "XXXXXXXXXXXXXXX")
...
gs <- factor(sml)
groups <- make.names(c("BioNormalFemales","BioRejectedFemales"))
levels(gs) <- groups
gset$group <- gs
...
par(mar=c(4,4,2,1))
title <- paste ("GSE50084", "/", annotation(gset), " value distribution", sep ="")
...
plotSA(fit2, main="Mean variance trend, GSE50084")
